...
| 54 | 145 Shelf filter sheet | `fixed` | ~~Opens already filtered and announces 418 titles.~~ Fixed 6 September: opens on nothing selected, counts the reader's own shelf, and offers that shelf's own genres. Decades and services are dropped on a device — no column holds a first-air year and nothing holds a catalogue. |
