defmodule Kati.Components.MishkaSemiCircleProgress do
  @moduledoc """
  ...
  def expand(props, _children, _ctx), do: semi_circle_progress(props)

  @doc """
  The gauge node.

      semi_circle_progress(value: 72, label: "Battery")
  """
  ...
  than a pixel.
      ...
      iex> alias Kati.Components.MishkaSemiCircleProgress, as: G
  ...
  defp readout(props, fraction) do
    case Map.get(props, :value_text) do
