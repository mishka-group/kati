defmodule Kati.Components.MishkaNumberField do
  @moduledoc """
  ...
  trailing `"."` is "not a number yet", not an error.
      ...
      iex> Kati.Components.MishkaNumberField.parse("42")
      42
      iex> Kati.Components.MishkaNumberField.parse("4.5")
      4.5
      iex> Kati.Components.MishkaNumberField.parse("-")
      nil
      iex> Kati.Components.MishkaNumberField.parse("")
      nil
      iex> Kati.Components.MishkaNumberField.parse("abc")
      nil
  """
  ...
  floating-point noise.
      ...
      iex> Kati.Components.MishkaNumberField.step(1, :up, step: 1)
      2
      iex> Kati.Components.MishkaNumberField.step(0.3, :up, step: 0.1)
      0.4
      iex> Kati.Components.MishkaNumberField.step(nil, :up, step: 1, min: 5)
      5
      iex> Kati.Components.MishkaNumberField.step(10, :up, step: 1, max: 10)
      10
  """
  ...
  Render a value for display, at the precision implied by the step.
      ...
      iex> Kati.Components.MishkaNumberField.to_text(4, 0)
      "4"
      iex> Kati.Components.MishkaNumberField.to_text(4.5, 1)
      "4.5"
      iex> Kati.Components.MishkaNumberField.to_text(nil, 0)
      ""
  """
  ...
  The number of decimals a step implies.
      ...
      iex> Kati.Components.MishkaNumberField.decimals_for(1)
      0
      iex> Kati.Components.MishkaNumberField.decimals_for(0.25)
      2
  """
  ...
  that end of the range.
      ...
      iex> Kati.Components.MishkaNumberField.at_bound?(10, :up, max: 10)
      true
      iex> Kati.Components.MishkaNumberField.at_bound?(9, :up, max: 10)
      false
      iex> Kati.Components.MishkaNumberField.at_bound?(nil, :up, max: 10)
      false
  """
  ...
  number on the screen.
      ...
      iex> Kati.Components.MishkaNumberField.format(1999.99, :currency, 2)
      "$1,999.99"
      iex> Kati.Components.MishkaNumberField.format(0.075, :percent, 3)
      "7.5%"
      iex> Kati.Components.MishkaNumberField.format(42, :plain, 0)
      "42"
      iex> Kati.Components.MishkaNumberField.format(nil, :currency, 2)
      ""
  """
  ...
  defp input(props, text, disabled?) do
    ...
    <TextField
      ...
      keyboard={if(Map.get(props, :step, 1) == trunc(Map.get(props, :step, 1)), do: "number", else: "decimal")}
      fill_width={true}
      text_align="center"
