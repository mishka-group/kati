defmodule Kati.Components.MishkaHueSlider do
  @moduledoc """
  ...
  `Kati.Components.MishkaSlider`), `step`/`large_step` (keyboard nudging),
  and `name`/`form`/`id`.
  """
  ...
  The inverse of the marker, so finger and marker cannot separate.
      ...
      iex> Kati.Components.MishkaHueSlider.hue_at(150, 300)
      180.0

      iex> Kati.Components.MishkaHueSlider.hue_at(300, 300)
      360.0

      iex> Kati.Components.MishkaHueSlider.hue_at(-40, 300)
      0.0
  """
  ...
  plain maps is far easier to assert on than a rendered gradient.
      ...
      iex> ops = Kati.Components.MishkaHueSlider.spectrum(10, 4, 0)
