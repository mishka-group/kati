defmodule Kati.Components.MishkaDrawer do
  @moduledoc """
  ...
  (`Kati.Components.Anchored`, which `popover` and friends put their panel
  ...
  **Verified on Android (Samsung A55, One UI / Android 15)** — all four sides
  ...
  `Kati.Components.MishkaMenu.item/3` returns a `<MishkaMenuItem>`: pass it
  ...
  exactly as it was:
      ...
      iex> alias Kati.Components.MishkaDrawer
  ...
  measure the viewport, so the caller states what the fraction is of.
      ...
      iex> Kati.Components.MishkaDrawer.snap_heights(%{snap_points: [440, 180]})
      [180, 440]

      iex> Kati.Components.MishkaDrawer.snap_heights(%{snap_points: [0.4, 0.76], extent: 500})
      [200.0, 380.0]
  ...
  `expand/3` logs it) rather than silently rendering a 0.4dp sheet:
      ...
      iex> Kati.Components.MishkaDrawer.snap_heights(%{snap_points: [0.4, 300]})
      [300]
  """
  ...
  cannot say which snap point produced it.
      ...
      iex> Kati.Components.MishkaDrawer.snap_index(%{snap_points: [180, 300], snap: 300})
      2

      iex> Kati.Components.MishkaDrawer.snap_index(%{snap_points: [180, 300]})
      1
  """
  ...
  edge when it is not given.
      ...
      iex> Kati.Components.MishkaDrawer.dismiss_direction(%{side: :bottom})
      :down

      iex> Kati.Components.MishkaDrawer.dismiss_direction(%{side: :bottom, swipe_direction: :right})
      :right
  """
