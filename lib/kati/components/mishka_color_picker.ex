defmodule Kati.Components.MishkaColorPicker do
  @moduledoc """
  ...
  alias Kati.Components.{Color, Event, MishkaHueSlider}
  ...
  `{s, v}`.
      ...
      iex> ops = Kati.Components.MishkaColorPicker.area(40, 40, 0, 50, 50)
  ...
  the area paints, so the ring lands under the finger.
      ...
      iex> Kati.Components.MishkaColorPicker.sv_at(0, 0, 260, 180)
      {0.0, 100.0}

      iex> Kati.Components.MishkaColorPicker.sv_at(260, 180, 260, 180)
      {100.0, 0.0}

      iex> Kati.Components.MishkaColorPicker.sv_at(130, 90, 260, 180)
      {50.0, 50.0}
  """
  ...
  The `{h, s, v}` a props map describes, defaulted and clamped.
      ...
      iex> Kati.Components.MishkaColorPicker.hsv(%{hue: 400, saturation: 120, value: -5})
      {40.0, 100, 0}
  """
  ...
  The hex the picker currently shows.
      ...
      iex> Kati.Components.MishkaColorPicker.hex(%{hue: 0, saturation: 100, value: 100})
      "#ff0000"
  """
