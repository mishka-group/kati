defmodule Kati.Components.MishkaSlider do
  @moduledoc """
  ...
  **`disabled` is deliberately absent.** The Compose slider updates its own
  ...
  may be pushed.
      ...
      iex> alias Kati.Components.MishkaSlider
  ...
  Parse the `"lo,hi"` string a range slider reports back.
      ...
      iex> Kati.Components.MishkaSlider.parse_range("12.0,30.5")
      {12.0, 30.5}

      iex> Kati.Components.MishkaSlider.parse_range("nonsense")
      :error
  """
  ...
  `:max` (default `100`).
      ...
      iex> Kati.Components.MishkaSlider.snap(42.7, step: 5)
      45
      iex> Kati.Components.MishkaSlider.snap(42.7, step: 1)
      43
      iex> Kati.Components.MishkaSlider.snap(999.0, step: 5)
      100
      iex> Kati.Components.MishkaSlider.snap(42.7, [])
      42.7
  """
