defmodule Kati.Components.MishkaMenubar do
  @moduledoc """
  ...
  (`Kati.Components.Anchored`), which `Kati.Components.MishkaPopover`
  is built on — and the menubar has simply not been moved onto it. It draws
  through `Kati.Components.MishkaMenu`, which is unchanged. `:anchored` is
  ...
  never leaving two open.
      ...
      iex> Kati.Components.MishkaMenubar.open_menu(:file, nil)
      :file

      iex> Kati.Components.MishkaMenubar.open_menu(:file, :file)
      nil

      iex> Kati.Components.MishkaMenubar.open_menu(:edit, :file)
      :edit
  """
