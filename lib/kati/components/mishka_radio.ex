defmodule Kati.Components.MishkaRadio do
  @moduledoc """
  Native Mob port of Mishka Chelekom's **headless Radio** — one option in a
  mutually exclusive set.

  Same row shape as `Kati.Components.MishkaCheckbox`, with the one visual
  ...
  A group of these is `Kati.Components.MishkaRadioGroup`'s job; a single
  ...
  `-selected` or `-empty`, the same trick `Kati.Components.MishkaCheckbox`
