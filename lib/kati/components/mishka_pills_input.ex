defmodule Kati.Components.MishkaPillsInput do
  @moduledoc """
  ...
  `Kati.Components.MishkaTagsInput` owns its tokens: you hand it strings
  and it renders them as pills with ✕ buttons. A pills input owns **nothing** —
  the caller supplies the pill nodes, which may be
  `Kati.Components.MishkaPill`s, avatars, colour swatches or anything else.
  ...
  packs an unbounded number onto one row.
      ...
      iex> alias Kati.Components.MishkaPillsInput, as: P
