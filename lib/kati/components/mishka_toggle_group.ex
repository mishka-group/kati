defmodule Kati.Components.MishkaToggleGroup do
  @moduledoc """
  ...
  Composes `Kati.Components.MishkaToggle`, so a lone toggle and a grouped
  ...
  Every styling prop `Kati.Components.MishkaToggle` takes — `color`,
  ...
  the note in `Kati.Components.MishkaToggle`.
  ...
  group, which keeps its selection.
      ...
      iex> Kati.Components.MishkaToggleGroup.press(nil, :a, false)
      :a
      iex> Kati.Components.MishkaToggleGroup.press(:a, :a, false)
      nil
      iex> Kati.Components.MishkaToggleGroup.press(:a, :b, false)
      :b
      iex> Kati.Components.MishkaToggleGroup.press([:a], :b, true)
      [:a, :b]
      iex> Kati.Components.MishkaToggleGroup.press([:a, :b], :a, true)
      [:b]
  """
  ...
  Whether `id` is pressed for a given value, in either mode.
      ...
      iex> Kati.Components.MishkaToggleGroup.pressed?(:a, :a)
      true
      iex> Kati.Components.MishkaToggleGroup.pressed?([:a, :b], :b)
      true
      iex> Kati.Components.MishkaToggleGroup.pressed?(nil, :a)
      false
  """
