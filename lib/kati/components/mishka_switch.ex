defmodule Kati.Components.MishkaSwitch do
  @moduledoc """
  ...
  **Padding is not an option for the inset.** Mob applies padding *before* width,
  ...
  — travels 9pt either side of centre:
      ...
      iex> Kati.Components.MishkaSwitch.thumb_offset(true, 46, 22, 3)
      9.0

      iex> Kati.Components.MishkaSwitch.thumb_offset(false, 46, 22, 3)
      -9.0
  ...
  # Everything else is widened to {pid, tag} — see Kati.Components.Event.
