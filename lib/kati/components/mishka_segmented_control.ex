defmodule Kati.Components.MishkaSegmentedControl do
  @moduledoc """
  ...
  `Kati.Components.MishkaToggleGroup` instead.
  ...
  @track_overrides ~w(width height align shadow)a
  ...
  rather than an empty state.
      ...
      iex> Kati.Components.MishkaSegmentedControl.select(:a, :b)
      :b
      iex> Kati.Components.MishkaSegmentedControl.select(:a, :a)
      :a
  """
