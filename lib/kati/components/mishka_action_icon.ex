defmodule Kati.Components.MishkaActionIcon do
  @moduledoc """
  ...
  A square tap target holding a glyph or nodes. `Kati.Components.MishkaCloseButton`
  ...
  any size.
      ...
      iex> Kati.Components.MishkaActionIcon.radius(:circle, 40)
      20.0
      iex> Kati.Components.MishkaActionIcon.radius(:rounded, 40)
      :radius_md
  """
