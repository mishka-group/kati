defmodule Kati.Components.MishkaSpoiler do
  @moduledoc """
  ...
  They share a mechanism and differ in intent, which changes the markup:
    ...
    * `Kati.Components.MishkaCollapsible` hides content behind a **titled
  ...
  The control's label for a state — the whole of the "changes as it works" rule.
      ...
      iex> Kati.Components.MishkaSpoiler.label(%{}, false)
      "Show more"
      iex> Kati.Components.MishkaSpoiler.label(%{}, true)
      "Show less"
      iex> Kati.Components.MishkaSpoiler.label(%{show_label: "Read on"}, false)
      "Read on"
  """
