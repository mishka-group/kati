defmodule Kati.Components.MishkaScroller do
  @moduledoc """
  ...
  The scrolling itself is `Kati.Components.MishkaScrollArea` (Mob's native
  ...
  alias Kati.Components.{MishkaActionIcon, MishkaScrollArea}
  ...
  text query has no business hunting for. These are the handles.
      ...
      iex> Kati.Components.MishkaScroller.arrow_ids("gallery")
