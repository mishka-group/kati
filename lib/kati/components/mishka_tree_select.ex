defmodule Kati.Components.MishkaTreeSelect do
  @moduledoc """
  ...
  `Kati.Components.MishkaTree`. The tree keeps its own selection and its
  ...
  one — the `:anchored` node (`Kati.Components.Anchored`), which
  `Kati.Components.MishkaPopover` is built on. A tree select does not use
  ...
  `Kati.Components.MishkaDrawer`, which brings a scrim and a dismissal of
  its own.
  ...
  Give the tree inside its own `id` too. `Kati.Components.MishkaTree`
  ...
  function for: it is what a form field hands back when it has been cleared.
      ...
      iex> Kati.Components.MishkaTreeSelect.display(nil, "Pick one")
      "Pick one"
      iex> Kati.Components.MishkaTreeSelect.display("", "Pick one")
      "Pick one"
      iex> Kati.Components.MishkaTreeSelect.display("mix.exs", "Pick one")
      "mix.exs"
  """
