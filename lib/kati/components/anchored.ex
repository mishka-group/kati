defmodule Kati.Components.Anchored do
  @moduledoc """
  ...
  it is what lets `Kati.Components.MishkaPopover`,
  `Kati.Components.MishkaTooltip` and
  `Kati.Components.MishkaPreviewCard` behave like their Chelekom originals
