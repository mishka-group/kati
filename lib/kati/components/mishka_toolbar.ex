defmodule Kati.Components.MishkaToolbar do
  @moduledoc """
  ...
  `Kati.Components.MishkaToggle` or a
  `Kati.Components.MishkaToggleGroup` beside its own items — it invents no
  ...
  the strip's Box. `overflow` names what to do instead:
    ...
    * `:collapse` — keep `visible` controls and put a `⋯` at the end, which
      ...
      `Kati.Components.MishkaDrawer`. `split/2` is the whole policy, pure
      and testable.
  ...
  *announced* name, which is the gap the hint works around.
  ...
  description, not an effect.
      ...
      iex> alias Kati.Components.MishkaToolbar
  ...
  untagged.
      ...
      iex> Kati.Components.MishkaToolbar.item_tag("fmt", :bold, false)
      "fmt-bold"

      iex> Kati.Components.MishkaToolbar.item_tag("fmt", :bold, true)
      "fmt-bold-disabled"

      iex> Kati.Components.MishkaToolbar.item_tag(nil, :bold, false)
      nil
  """
  ...
  place it survives.
      ...
      iex> Kati.Components.MishkaToolbar.group_tag("fmt", "Text align")
      "fmt-group-text-align"

      iex> Kati.Components.MishkaToolbar.group_tag("fmt", nil)
      nil
  """
  ...
  The test tag on the `⋯`.
      ...
      iex> Kati.Components.MishkaToolbar.overflow_tag("fmt")
      "fmt-overflow"
  """
  ...
  The test tag on the hint caption.
      ...
      iex> Kati.Components.MishkaToolbar.hint_tag("fmt")
      "fmt-hint"
  """
  ...
  without a finger.
      ...
      iex> Kati.Components.MishkaToolbar.scroll_tag("fmt")
      "fmt-scroll"
  """
  ...
  defp context(props, overflow) do
    ...
    %{
      ...
      focusable?: Map.get(props, :focusable_when_disabled) != false,
