defmodule Kati.Components.MishkaToggle do
  @moduledoc """
  ...
  apart on purpose:
    ...
    * `Kati.Components.MishkaSwitch` — a *setting*. Wraps the platform's
      real switch widget; belongs beside a label in a settings list.
    * `Kati.Components.MishkaChip` — a *filter*, one of a set you pick
