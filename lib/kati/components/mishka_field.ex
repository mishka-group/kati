defmodule Kati.Components.MishkaField do
  @moduledoc """
  ...
  `Kati.Components.MishkaSwitch`, anything.
  ...
  control can tint its own border to match.
      ...
      iex> Kati.Components.MishkaField.invalid?(%{errors: ["too short"]})
      true
      iex> Kati.Components.MishkaField.invalid?(%{errors: []})
      false
      iex> Kati.Components.MishkaField.invalid?(%{errors: [nil, ""]})
      false
  """
