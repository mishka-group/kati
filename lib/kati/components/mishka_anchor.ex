defmodule Kati.Components.MishkaAnchor do
  @moduledoc """
  ...
  the screen's business:
    ...
    * an external URL → `Kati.Components.MishkaAnchor.open/1`, which wraps
  ...
  `Kati.Components.MishkaScroller` follows. `on_tap` therefore carries the
  ...
  component should never hand an arbitrary string to the platform's URL opener.
      ...
      iex> Kati.Components.MishkaAnchor.open("ftp://example.com")
      :error

      iex> Kati.Components.MishkaAnchor.open(nil)
      :error
  """
