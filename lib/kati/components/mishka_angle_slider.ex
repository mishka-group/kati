defmodule Kati.Components.MishkaAngleSlider do
  @moduledoc """
  ...
  `Kati.Components.MishkaSlider.snap/2`), `disabled`, and `name`/`form`/`id`.
  """
  ...
  otherwise spin the value through a full turn over a few pixels.
      ...
      iex> Kati.Components.MishkaAngleSlider.angle_at(80, 10, 160)
      0.0

      iex> Kati.Components.MishkaAngleSlider.angle_at(150, 80, 160)
      90.0

      iex> Kati.Components.MishkaAngleSlider.angle_at(80, 80, 160)
      :dead
  """
  ...
  back the other way.
      ...
      iex> alias Kati.Components.MishkaAngleSlider, as: A
  ...
  Pass `:dead` straight through — there was no angle to follow.
      ...
      iex> Kati.Components.MishkaAngleSlider.follow(90.0, :dead)
      90.0
  """
  ...
  defp canvas_node(size, ops, handler, id) do
  ...
  Draw ops for the dial at `angle`.
      ...
      iex> ops = Kati.Components.MishkaAngleSlider.dial(100, 90, %{})
  ...
  defp reading(center, angle, props) do
    ...
    if Map.get(props, :show_value) != false do
      [
  ...
  pointing **up** and increasing **clockwise**.
      ...
      iex> Kati.Components.MishkaAngleSlider.point_on_dial(50, 50, 40, 0)
      {50.0, 10.0}

      iex> Kati.Components.MishkaAngleSlider.point_on_dial(50, 50, 40, 90)
      {90.0, 50.0}

      iex> Kati.Components.MishkaAngleSlider.point_on_dial(50, 50, 40, 180)
      {50.0, 90.0}
  """
