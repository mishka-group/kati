defmodule Kati.Components.MishkaCheckboxGroup do
  @moduledoc """
  ...
  Composes `Kati.Components.MishkaCheckbox` for both the children and the
  ...
  `Kati.Components.MishkaCheckbox`.
  ...
  Add or remove `id` from the selection, preserving order.
      ...
      iex> Kati.Components.MishkaCheckboxGroup.toggle([:a], :b)
      [:a, :b]
      iex> Kati.Components.MishkaCheckboxGroup.toggle([:a, :b], :a)
      [:b]
  """
  ...
  asking to be completed, not emptied.
      ...
      iex> Kati.Components.MishkaCheckboxGroup.select_all([], [:a, :b])
      [:a, :b]
      iex> Kati.Components.MishkaCheckboxGroup.select_all([:a], [:a, :b])
      [:a, :b]
      iex> Kati.Components.MishkaCheckboxGroup.select_all([:a, :b], [:a, :b])
      []
  """
  ...
  The `{checked?, indeterminate?}` the parent should render for a selection.
      ...
      iex> Kati.Components.MishkaCheckboxGroup.parent_state([], [:a, :b])
      {false, false}
      iex> Kati.Components.MishkaCheckboxGroup.parent_state([:a], [:a, :b])
      {false, true}
      iex> Kati.Components.MishkaCheckboxGroup.parent_state([:a, :b], [:a, :b])
      {true, false}
  """
