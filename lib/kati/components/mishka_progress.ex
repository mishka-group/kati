defmodule Kati.Components.MishkaProgress do
  @moduledoc """
  ...
  both are the edges where a naive implementation breaks:
    ...
    * **at 0% the fill node is omitted entirely**, in both shapes. Not for
      ...
      `Kati.Components.MishkaSemiCircleProgress` omits its indicator arc at
  ...
  indeterminate. Exposed because it is the whole of the range logic.
      ...
      iex> Kati.Components.MishkaProgress.fraction(%{value: 50})
      0.5
      iex> Kati.Components.MishkaProgress.fraction(%{value: 3, max: 5})
      0.6
      iex> Kati.Components.MishkaProgress.fraction(%{value: 999})
      1.0
      iex> Kati.Components.MishkaProgress.fraction(%{})
      nil
      iex> Kati.Components.MishkaProgress.fraction(%{value: "72"})
      0.72
  """
  ...
  bar leaves of its fraction, which is a width rather than a prop.
      ...
      iex> Kati.Components.MishkaProgress.fill_id("upload")
      "upload-fill"
