defmodule Kati.Components.MishkaCloseButton do
  @moduledoc """
  Native Mob port of Mishka Chelekom's **headless Close Button** — the ✕ that
  dismisses a dialog, a drawer, a toast or a card.

  A thin wrapper over `Kati.Components.MishkaActionIcon` with the ✕ and a
  ...
  Everything `Kati.Components.MishkaActionIcon` accepts. `icon` defaults to
