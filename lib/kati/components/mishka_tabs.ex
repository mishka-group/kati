defmodule Kati.Components.MishkaTabs do
  @moduledoc """
  ...
  The test tag on the scrolling strip, given the tabs' `id`.
      ...
      iex> Kati.Components.MishkaTabs.strip_id("plans")
      "plans-strip"
  """
  ...
  cannot tell the selected tab from any other.
      ...
      iex> Kati.Components.MishkaTabs.tab_id("plans", :pro, :active)
  ...
  The test tag on the panel below the strip.
      ...
      iex> Kati.Components.MishkaTabs.panel_id("plans")
      "plans-panel"
  """
