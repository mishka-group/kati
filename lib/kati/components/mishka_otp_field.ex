defmodule Kati.Components.MishkaOtpField do
  @moduledoc """
  ...
  **invisible `TextField` is stacked over them** — transparent background, text,
  ...
  are dropped rather than the whole paste rejected.
      ...
      iex> Kati.Components.MishkaOtpField.sanitize("12-34-56", length: 6)
      "123456"
      iex> Kati.Components.MishkaOtpField.sanitize("1234567890", length: 4)
      "1234"
      iex> Kati.Components.MishkaOtpField.sanitize("a1b2", validation_type: :alpha)
      "ab"
      iex> Kati.Components.MishkaOtpField.sanitize("a1-b2", validation_type: :alphanumeric)
      "a1b2"
  """
  ...
  Whether the code fills every slot — what a screen checks before auto-submitting.
      ...
      iex> Kati.Components.MishkaOtpField.complete?("123456", length: 6)
      true
      iex> Kati.Components.MishkaOtpField.complete?("123", length: 6)
      false
  """
  ...
  An integer groups evenly, the way the web component's `group` does:
      ...
      iex> Kati.Components.MishkaOtpField.boundaries(3)
      [3, 6, 9, 12, 15, 18]
  ...
  then four, and an even `group: 3` over seven slots would give `Abs-556-3`:
      ...
      iex> Kati.Components.MishkaOtpField.boundaries([3, 4])
      [3]

      iex> Kati.Components.MishkaOtpField.boundaries([2, 2, 2])
      [2, 4]

      iex> Kati.Components.MishkaOtpField.boundaries(nil)
      []
  """
