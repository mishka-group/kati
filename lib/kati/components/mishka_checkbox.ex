defmodule Kati.Components.MishkaCheckbox do
  @moduledoc """
  ...
  tristate parent, because "some are selected" most usefully becomes "all are".
      ...
      iex> Kati.Components.MishkaCheckbox.toggle(%{checked: false})
      {true, false}
      iex> Kati.Components.MishkaCheckbox.toggle(%{checked: true})
      {false, false}
      iex> Kati.Components.MishkaCheckbox.toggle(%{indeterminate: true})
      {true, false}
  """
