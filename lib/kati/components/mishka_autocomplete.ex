defmodule Kati.Components.MishkaAutocomplete do
  @moduledoc """
  ...
  So this renders through `Kati.Components.MishkaCombobox` (same filtering,
  ...
  (`Kati.Components.Anchored`) does float a panel in its own window, and
  `Kati.Components.MishkaPopover` is built on it. The suggestions stay in
  ...
  alias Kati.Components.MishkaCombobox
  ...
  already matches one exactly.
      ...
      iex> alias Kati.Components.MishkaAutocomplete, as: A
  ...
  nothing left to suggest.
      ...
      iex> Kati.Components.MishkaAutocomplete.exact?(["Iran"], "iran")
      true
      iex> Kati.Components.MishkaAutocomplete.exact?(["Iran"], "ir")
      false
      iex> Kati.Components.MishkaAutocomplete.exact?(["Iran"], "")
      false
  """
  ...
  Whether `suggestion` is exactly what the query already says.
      ...
      iex> Kati.Components.MishkaAutocomplete.exact_match?("Iran", "iran")
      true
      iex> Kati.Components.MishkaAutocomplete.exact_match?("Ireland", "iran")
      false
  """
