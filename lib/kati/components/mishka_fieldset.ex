defmodule Kati.Components.MishkaFieldset do
  @moduledoc """
  ...
  | `color` | color token / ARGB int | `:on_surface` | The legend. Set it whenever you set `background`. |
  ...
  def fieldset(props \\ %{}, children \\ []) do
    ...
    # sets their own `background` it stops being one — a tinted panel keeps
    # near-black text and the legend becomes hard to read. So the ink is a prop
