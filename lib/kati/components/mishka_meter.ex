defmodule Kati.Components.MishkaMeter do
  @moduledoc """
  ...
  `Kati.Components.MishkaProgress.fraction/1` for the range maths rather
  ...
  `Kati.Components.MishkaProgress`, which owns the drawing and documents
  ...
  web component's `--chelekom-meter` custom property.
      ...
      iex> Kati.Components.MishkaMeter.ratio(%{value: 72})
      0.72
      iex> Kati.Components.MishkaMeter.ratio(%{})
      0.0
  """
  ...
  `render={:box}`. Delegated, because the fill is `MishkaProgress`'s node.
      ...
      iex> Kati.Components.MishkaMeter.fill_id("storage")
      "storage-fill"
  """
