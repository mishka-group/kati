defmodule Kati.Fa.SampleYear do
  ...
  def year do
    %{
      ...
      week: week(),
      days: ["ش", "ی", "د", "س", "چ", "پ", "ج"],
      note: "نمودارها هم برعکس می‌شوند: محور زمان از راست به چپ خوانده می‌شود " <>
  ...
  def contributions do
    [
      2, 0, 0, 0, 1, 4, 0, 1, 2, 0, 3, 2, 2, 2, 1, 2, 3, 0, 3, 2, 0, 2, 0, 3, 2, 1,
      0, 3, 0, 2, 0, 2, 1, 0, 2, 2, 0, 1, 1, 3, 0, 2, 2, 4, 3, 2, 3, 0, 3, 1, 0, 0,
      1, 1, 1, 2, 1, 1, 3, 3, 2, 4, 3, 2, 3, 2, 0, 3, 3, 0, 3, 0, 3, 0, 2, 0, 4, 3,
      0, 1, 3, 1, 4, 3, 3, 0, 2, 1, 1, 1, 4, 0, 1, 1, 2, 0, 1, 1, 3, 0, 4, 2, 1, 2
    ]
  end
