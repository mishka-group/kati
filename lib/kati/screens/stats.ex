defmodule Kati.Screens.Stats do
  @moduledoc "The Stats root. Placeholder content until its own tickets land."
  ...
  defp content(_assigns) do
    ...
    <Scroll background={:background}>
      <Column background={:background} padding={21} fill_width={true}>
        <Spacer size={64} />
        <Text text="Stats" text_size={34} text_color={:on_surface} font_weight="bold" />
        <Spacer size={8} />
        <Text text="Root stats" text_size={13} text_color={:muted} />
        <Spacer size={24} />
        {Kati.Screens.Stats.card("Nothing here yet", "This root is drawn so the shell can be judged as a whole. Its own screens arrive with their tickets.")}
        <Spacer size={132} />
      </Column>
    </Scroll>
    """
