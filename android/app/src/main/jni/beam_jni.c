...
// ── KATI PATCH START: drop the orphaned location JNI stub ────────────────
...
// halves.
// ── KATI PATCH END: drop the orphaned location JNI stub ──────────────────
...
// ── KATI PATCH START: drop JNI stubs for plugin-extracted features ───────
...
// ── KATI PATCH END: drop JNI stubs for plugin-extracted features ─────────
