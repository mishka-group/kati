...
The no-goals state, carrying the one sentence the brief specifies verbatim.

## Where it is reached from

Same route as the Goals screen — screen 07's "More numbers" row — entered before any goal exists.

## Bands, top to bottom

1. Back pill "‹ Stats"
2. Large title "Goals"
3. Empty block in screen 27's geometry: a glyph (glyph not specified by the ticket)
4. Sentence, verbatim and protected in review: "No goals. Kati will still count everything."
5. Ink primary button (44–54px, #1A1917) — label not specified; 27's parallel is "Add a title"
6. Secondary text action beneath — not specified; 27's parallel is "or import a backup"
...
Screen 27 empty-state geometry (glyph → sentence → ink button → secondary text action); primary ink button recipe ("ink is the only button colour"); back pill.

## Left open — decide and note which way you went

The glyph; the ink button label; the secondary text action label; whether this is its own artboard or the empty band of the Goals screen.
