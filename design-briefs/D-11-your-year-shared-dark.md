# Your year, shared — dark

> **Full screen** · issue [#14](https://github.com/mishka-group/kati/issues/14) · ticket `D-11`

The same share screen at night, including the card itself, because a saved image carries the theme it was made in.

## Where it is reached from

Same entry as 63 — screen 07's header `ios_share` disc — with the app in dark. Precedent: screen 28 is screen 01 drawn separately for dark.

## Bands, top to bottom

1. Back pill `‹ Stats` on near-black paper #121110
2. Large title + mono year-range subtitle in #F5F2EE
3. Section switcher chip row, dark fills
4. Card pager — the card itself rendered dark: card #1E1D1B, hairline `inset 0 0 0 1px rgba(245,242,238,.06)` instead of a shadow, bronze ramp and four-tone bar ramp restated for dark
5. Aspect segmented control: Square · Story
6. Toggle row: "Hide titles I marked private"
7. Ink "Save image" primary button
8. Quiet "Share…" secondary, same pending annotation
9. Info footnote — renders on device, nothing uploaded
...
Screen 28's dark treatment (paper #121110, card #1E1D1B, hairline-instead-of-shadow, cream → #2A2622 with #F7EFE4 text); all of 63's controls.

## Left open — decide and note which way you went

Whether the bronze pixel ramp and the four-tone bar ramp need dark-specific values, or hold as-is on #1E1D1B — the ticket does not restate them for dark. Still no orange.
