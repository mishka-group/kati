...
The Persian mirror of the My services screen, proving rows, chevrons and mono prices survive the direction flip.

## Where it is reached from

Screen 62 'تنظیمات — Settings, RTL' (62.html exists), the RTL counterpart of the screen-24 entry row. Back chevron becomes arrow_forward_ios per the RTL rule.

## Bands, top to bottom

1. Back pill with arrow_forward_ios + Persian parent label
2. Large title and subtitle in Persian (ticket does not supply the Persian strings)
3. REGION row mirrored — icon right, chevron flipped to chevron_left, as screen 62 specifies
4. Region footnote, Vazirmatn, no letter-spacing, taller line-height
5. Search field mirrored
6. SUBSCRIBED group — provider badge + name mirrored; prices stay DM Mono with Persian digits and the Persian decimal separator U+066B, e.g. ۸٫۹۹ پوند
7. FREE WITH ADS and NOT MINE groups mirrored, 'Show all 47' count in Persian digits
8. RULES — three toggle rows mirrored with their consequence lines
9. Money link row mirrored, amount in Persian digits
10. JustWatch attribution footnote → D-05
...
Screen 62's wholesale row mirroring with chevron_left (design-index.md:160); Vazirmatn typography rules (:374-378); DM Mono retained for numerals with Persian digits; all the LTR recipes unchanged — RTL is a container attribute, not a fork (:359-362).

## Left open — decide and note which way you went

All Persian strings. The currency symbol is explicitly out of scope here — see D-21, which owns money and currency. Whether the Persian screen shows original service names alongside transliterations (the screen-54 'show originals' setting).
