...
Preview a plan received by QR or link and resolve which of its meals you already have, before anything is written.

## Where it is reached from

Screen 50, the `qr_code_scanner` row 'Scan a plan / From a QR code or link' (and `upload_file` 'Import a file') — both confirmed in 50.html.

## Bands, top to bottom

1. Back pill '‹ Plans' + title with a step kicker in 37's idiom ('step 3 of 4')
2. Source card — the incoming plan (50's example: 'kati://plan/cutting-v3 · 35 meals')
3. 'What will happen' counts in 37's idiom (New / Merged / Conflicts)
4. Conflict resolver, one at a time — 'Keep mine / Take file / Keep both', '1 of 6 · apply to all'
5. What does not travel — history and notes, per 50's 'Never shared'

## States to draw

- A shared plan whose meals you do not have (the ticket's stated case)
- Imported ingredient with no aisle → 'Uncategorised'
- Imported meals with incomplete nutrition → approximate marks
- RTL

## Reuse, do not invent

Screen 37's whole import idiom (file card, mapping rows, counts row, conflict resolver); back pill; elevated card; info footnote

## Left open — decide and note which way you went

Whether this is a new artboard or a variant of 37 — the ticket frames it as a state, not one of its three named screens. Whether import pushes from 50 or opens as a modal.
