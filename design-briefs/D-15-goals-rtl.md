...
The Goals screen in Persian, where a "this year" goal ends at the end of اسفند, not 31 December.

## Where it is reached from

Screen 61 آمار (the fa Stats root, mirror of 07) — its mirrored "More numbers" row. 61.html confirmed present.

## Bands, top to bottom

1. Back pill mirrored: `arrow_forward_ios` + آمار
2. Title اهداف, Vazirmatn, no letter-spacing, taller line-height (1.4)
3. Goal card mirrored: target sentence in Persian — copy not specified by the ticket
4. Hero numeral stays DM Mono with Persian digits (۳۸ / ۵۲) so the column still aligns
5. Progress bar fills from the right (per 57)
6. Projection line naming the Shamsi period end — end of اسفند ۱۴۰۵, not 31 December; this is the single most important i18n consequence on the screen
7. Pixel field starts its year in the top-right corner (per 61)

## States to draw

- RTL
- Persian / Shamsi year boundary

## Reuse, do not invent

Screen 61's chart-mirroring rules (right-to-left time axis, bars fill from the right, pixel field starts top-right); 57's right-filling progress bars; the fa row of the locale table (RTL, Shamsi, ۱۲۳۴, week starts Saturday, Vazirmatn); RTL back pill.

## Left open — decide and note which way you went

All Persian copy — target sentence, projection line, empty-state sentence; whether the fa pass is a full mirrored screen or only the goal card is drawn; Persian percent/decimal glyphs in the projection.
