...
List medications and their schedules, and mark each dose taken, missed or skipped — drawn only if the owner accepts the honesty note; retiring the tile is an equally valid answer.

## Where it is reached from

Screen 42 Health hub, the "Medication" tile in the Sections tile grid (today reads "Not set up"). Parent confirmed in 42.html / lib/kati/screens/health.ex. Pushed screen, back pill "‹ Health".

## Bands, top to bottom

1. Back pill "‹ Health" + large-title header "Medication"
2. List of medications with schedule rows
3. Per-dose state — taken / missed / skipped, reusing screen 43's eaten / skipped / upcoming meal-card treatment
4. The reminder drawn as a real lock-screen notification bubble in screen 51's style
5. Reliability note (info footnote): reminders can be late if the phone restricts alarms, and Kati is not a medical device — copy not given, only the two claims it must make

## States to draw

- No medications yet — screen 27's empty-state geometry
- Dose taken / missed / skipped
- Dark
- RTL

## Reuse, do not invent

Back pill; list row; screen 43's eaten/skipped/upcoming card states; screen 51's notification bubble; info footnote card; toggle row; screen 27's empty state

## Left open — decide and note which way you went

Build vs retire is explicitly the owner's call — the ticket says retiring is legitimate if the honesty note is unacceptable. Exact wording of the reliability note. Whether reminder manners rows (quiet hours etc.) live here or on 51. Relationship to D-23's notification diagnostic screen.
