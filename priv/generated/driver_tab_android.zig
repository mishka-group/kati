...
extern fn kati_secure_store_nif_init() callconv(.c) ?*anyopaque;
extern fn kati_bridge_nif_init() callconv(.c) ?*anyopaque;
...
const base_nifs = [_]ErtsStaticNif{
    ...
    .{ .nif_init = kati_secure_store_nif_init, .is_builtin = 0, .nif_mod = THE_NON_VALUE, .entry = null },
    .{ .nif_init = kati_bridge_nif_init, .is_builtin = 0, .nif_mod = THE_NON_VALUE, .entry = null },
};
